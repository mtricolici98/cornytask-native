...
class MoodNotificationReceiver : BroadcastReceiver() {
    ...
    private fun showMoodNotification(context: Context, label: String) {
        ...
        val title = "Track your mood"
        val message = "It's $label — take a moment to log how you feel."
    ...
    companion object {
        ...
        const val EXTRA_OPEN_ADD_MOOD = "openAddMood"

        private const val CHANNEL_ID = "mood_reminders"
        private const val CHANNEL_NAME = "Mood reminders"
